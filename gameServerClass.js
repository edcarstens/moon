...
class gameServerClass {
    ...
    async trick(
        ...
        for (let player of players) {
            ...
            let result = await this.playerTurn(player, {cmd:'play', bones:pool, stats:stats, bid:this.bid, maxBone:maxBone, trump:this.call}, 20)
            let {boneId} = result
            let bone = this.bonepool[boneId]
            bone.played = true
            bone.faceup = true
