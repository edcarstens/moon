...
moon.boneClickedOrBot = async function(
) {
...
moon.boneClicked = async function(
) {
    let {boneId} = await this.boneClickedOrBot()
    return boneId
}

moon.rxRoom = async function(
) {
    return new Promise( (resolve, reject) => {
...
moon.bidClicked = async function(
) {
    return new Promise( (resolve, reject) => {
...
moon.callClicked = async function(
) {
    return new Promise( (resolve, reject) => {
